...
class BulkActionsInner extends PureComponent {
  ...
  render() {
    ...
    const groupContent = promotedActionsMarkup || actionsPopover ? /*#__PURE__*/React.createElement(InlineStack, {
      gap: "300",
      blockAlign: "center"
    }, /*#__PURE__*/React.createElement(CheckableButton, checkableButtonProps), /*#__PURE__*/React.createElement(InlineStack, {
      gap: "100",
      blockAlign: "center"
    ...
    const group = /*#__PURE__*/React.createElement(Transition, {
      ...
      const groupClassName = classNames(styles.Group, !isSticky && styles['Group-not-sticky'], status && styles[`Group-${status}`]);
...
const BulkActions = /*#__PURE__*/forwardRef(function BulkActions(props, ref) {
  const i18n = useI18n();
