...
function ResourceList({
  ...
  const paginationWrapperClassNames = classNames(styles.PaginationWrapper, selectedItems && selectedItems.length && styles.PaginationWrapperWithSelectAllActions, isScrolledPastTop && styles.PaginationWrapperScrolledPastTop);
  ...
  const resourceListWrapperClasses = classNames(styles.ResourceListWrapper, Boolean(selectAllActionsMarkup) && selectMode &&
  // bulkActions &&
  !pagination && styles.ResourceListWrapperWithBulkActions);
