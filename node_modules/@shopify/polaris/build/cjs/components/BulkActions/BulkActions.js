...
class BulkActionsInner extends React.PureComponent {
  ...
  render() {
    ...
    const groupContent = promotedActionsMarkup || actionsPopover ? /*#__PURE__*/React.createElement(InlineStack.InlineStack, {
      gap: "300",
      blockAlign: "center"
    }, /*#__PURE__*/React.createElement(CheckableButton.CheckableButton, checkableButtonProps), /*#__PURE__*/React.createElement(InlineStack.InlineStack, {
      gap: "100",
      blockAlign: "center"
    ...
    const group = /*#__PURE__*/React.createElement(reactTransitionGroup.Transition, {
      ...
      const groupClassName = css.classNames(BulkActions_module.default.Group, !isSticky && BulkActions_module.default['Group-not-sticky'], status && BulkActions_module.default[`Group-${status}`]);
...
const BulkActions = /*#__PURE__*/React.forwardRef(function BulkActions(props, ref) {
