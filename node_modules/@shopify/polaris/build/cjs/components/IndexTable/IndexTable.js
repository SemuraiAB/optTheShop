...
var useIsSelectAllActionsSticky = require('../SelectAllActions/hooks/use-is-select-all-actions-sticky.js');
...
function IndexTableBase({
  ...
  } = useIsSelectAllActionsSticky.useIsSelectAllActionsSticky({
    selectMode,
  ...
  React.useEffect(() => {
    const callback = mutationList => {
      const hasChildList = mutationList.some(mutation => mutation.type === 'childList');
      if (hasChildList) {
        computeTableDimensions();
      }
    };
  ...
  const selectAllActionsClassNames = css.classNames(IndexTable_module.default.SelectAllActionsWrapper, isSelectAllActionsSticky && IndexTable_module.default.SelectAllActionsWrapperSticky, !isSelectAllActionsSticky && !pagination && IndexTable_module.default.SelectAllActionsWrapperAtEnd, selectMode && !isSelectAllActionsSticky && !pagination && IndexTable_module.default.SelectAllActionsWrapperAtEndAppear);
  const shouldShowActions = !condensed || selectedItemsCount;
  const promotedActions = shouldShowActions ? promotedBulkActions : [];
  const actions = shouldShowActions ? bulkActions : [];
  const selectAllActionsMarkup = shouldShowActions && !condensed ? /*#__PURE__*/React.createElement("div", {
    className: selectAllActionsClassNames,
    style: {
      insetBlockEnd: isSelectAllActionsSticky ? selectAllActionsOffsetBottom : undefined,
      insetBlockStart: isSelectAllActionsSticky ? undefined : selectAllActionsAbsoluteOffset,
      width: selectAllActionsMaxWidth,
      insetInlineStart: isSelectAllActionsSticky ? selectAllActionsOffsetLeft : undefined
    }
  ...
  const scrollBarWrapperClassNames = css.classNames(IndexTable_module.default.ScrollBarContainer, pagination && IndexTable_module.default.ScrollBarContainerWithPagination, shouldShowBulkActions && IndexTable_module.default.ScrollBarContainerWithSelectAllActions, selectMode && isSelectAllActionsSticky && IndexTable_module.default.ScrollBarContainerSelectAllActionsSticky, condensed && IndexTable_module.default.scrollBarContainerCondensed, hideScrollContainer && IndexTable_module.default.scrollBarContainerHidden, isScrolledPastTop && (pagination || shouldShowBulkActions) && IndexTable_module.default.ScrollBarContainerScrolledPastTop);
  ...
  const tableWrapperClassNames = css.classNames(IndexTable_module.default.IndexTableWrapper, Boolean(selectAllActionsMarkup) && selectMode && !pagination && IndexTable_module.default.IndexTableWrapperWithSelectAllActions);
  const paginationWrapperClassNames = css.classNames(IndexTable_module.default.PaginationWrapper, shouldShowBulkActions && IndexTable_module.default.PaginationWrapperWithSelectAllActions, isScrolledPastTop && IndexTable_module.default.PaginationWrapperScrolledPastTop);
  ...
  }, !shouldShowBulkActions && !condensed && loadingMarkup, tableContentMarkup, scrollBarMarkup, paginationMarkup), /*#__PURE__*/React.createElement("div", {
    ref: selectAllActionsIntersectionRef
  })));
