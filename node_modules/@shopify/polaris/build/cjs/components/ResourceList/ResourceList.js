...
function ResourceList({
  ...
  const selectAllActionsClassNames = css.classNames(ResourceList_module.default.SelectAllActionsWrapper, isSelectAllActionsSticky && ResourceList_module.default.SelectAllActionsWrapperSticky, !isSelectAllActionsSticky && !pagination && ResourceList_module.default.SelectAllActionsWrapperAtEnd, selectMode && !isSelectAllActionsSticky && !pagination && ResourceList_module.default.SelectAllActionsWrapperAtEndAppear);
  const selectAllActionsMarkup = isSelectable ? /*#__PURE__*/React.createElement("div", {
    className: selectAllActionsClassNames,
    style: {
      top: isSelectAllActionsSticky ? undefined : selectAllActionsAbsoluteOffset,
      width: selectAllActionsMaxWidth,
      bottom: isSelectAllActionsSticky ? selectAllActionsOffsetBottom : undefined,
  ...
  const bulkActionsMarkup = isSelectable && (bulkActions || promotedBulkActions) ? /*#__PURE__*/React.createElement("div", {
  ...
  const paginationWrapperClassNames = css.classNames(ResourceList_module.default.PaginationWrapper, selectedItems && selectedItems.length && ResourceList_module.default.PaginationWrapperWithSelectAllActions, isScrolledPastTop && ResourceList_module.default.PaginationWrapperScrolledPastTop);
  ...
  const resourceListWrapperClasses = css.classNames(ResourceList_module.default.ResourceListWrapper, Boolean(selectAllActionsMarkup) && selectMode &&
  // bulkActions &&
  !pagination && ResourceList_module.default.ResourceListWrapperWithBulkActions);
  ...
  }, headerMarkup, listMarkup, emptySearchStateMarkup, emptyStateMarkup, loadingWithoutItemsMarkup, paginationMarkup), /*#__PURE__*/React.createElement("div", {
