import { applyParams, preventCrossShopDataAccess, save, ActionOptions, HostOnShopifyShopifyProductImageActionContext } from "gadget-server";
...
export async function run({ params, record, logger, api, connections }) {
  ...
  const altText = params.shopifyProductImage.alt;
  if (!sourceURL) {
